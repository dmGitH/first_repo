...
public class TetelTorlesKerdes extends HttpServlet {
...
//<editor-fold defaultstate="collapsed" desc="kiküldöm a kérdést, hogy biztosan törli e az alapanyagot (tokennel meg minden ami kell hozzá, hogy tudjam ki válaszol)">
                        regoldal = oldalak.oldal_kerese(7);
                        regoldal = regoldal.replaceAll(":##:", "Biztos benne, hogy törli ezt a tételt? :" + request.getParameter("torol"));
                        regoldal = regoldal.replaceAll(":#K#:KEPET", kep.kepet());
                        regoldal = regoldal.replaceAll(":#HOVAKULDI#:", "TetelTorolValidalas");
                        regoldal = regoldal.replaceAll(":#ATOK#:", request.getParameter("atok"));
                        regoldal = regoldal.replaceAll(":#parameter#:", request.getParameter("honnan"));
                        regoldal = regoldal.replaceAll(":#torol#:", request.getParameter("torol"));
                        out.println(regoldal);
                    }
//</editor-fold>
                }
