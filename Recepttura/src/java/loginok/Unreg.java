...
public class Unreg extends HttpServlet {
...
//<editor-fold defaultstate="collapsed" desc="kiküldöm a kérdést, hogy biztosan törli e a regisztrációt (tokennel meg minden ami kell hozzá, hogy tudjam ki válaszol)">
                        regoldal = oldalak.oldal_kerese(7);
                        regoldal = regoldal.replaceAll(":##:", "Biztos benne, hogy törli a regisztrációját és minden nem publikált, felvitt adatot?");
                        regoldal = regoldal.replaceAll(":#K#:KEPET", kep.kepet());
                        regoldal = regoldal.replaceAll(":#HOVAKULDI#:", "UnregValidalas");
                        regoldal = regoldal.replaceAll(":#ATOK#:", userlog.atokir(id, c.getTimeInMillis(), 180000, "UNREG"));
                        out.println(regoldal);
                    }
//</editor-fold>
                }
